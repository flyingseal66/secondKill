package org.secondKill.java_learning.NIO.example;
    ...
    private void listener() throws IOException{
        ...
        while(true) {
            ...
            while(iterator.hasNext()) {
                ...
                System.out.println("key ready ops:" + key.readyOps());
...
//            System.out.println("有客户端连接，IP地址为 :" + sc.getRemoteAddress());
            ...
            System.out.println("enter isAcceptable");
        }
        //处理来自客户端的数据读取请求
        if(key.isReadable()){
...
//                System.out.println("从IP地址为：" + sc.getRemoteAddress() + "的获取到消息: " + content);
            ...
            System.out.println("enter isReadable");
        }
        if (key.isWritable()) {
            System.out.println("enter Writable");
        }
    }
